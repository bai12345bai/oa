...
<head>
 ...
 <script type="text/JavaScript" defer="true">
		function openWindow(){
    var address=window.showModalDialog("address.html","","dialogWidth=340px;dialogHeight=270px");
...
<div id="container">
    ...
    <div class="buy">
			<h4><img src="images/p_mycar.gif" alt="alt" /> <a href="#">全场运费一律2元</a> <a href="#" class="b" onclick="JavaScript:window.open('calc.html','计算器','width=200,height=200,toolbar=no,scrollbars=no,menubar=no,screenX=100,screenY=100')">简易计算器</a></h4>
      ...
      <tr class="h26 blue">
        <td><a href="info.html" title="攀高搓捶背靠垫按摩器（蓝色 ）（定制）">&nbsp;&nbsp;&nbsp;&nbsp;攀高搓捶背靠垫按摩器（蓝色 ）（定制）</a></td>
      ...
      <tr class="h26 blue">
        <td><a href="info.html" title="郝彬美国口语-美国口语成功训练系统（MP3）">&nbsp;&nbsp;&nbsp;&nbsp;郝彬美国口语-美国口语成功训练系统（MP3）</a></td>
      ...
      <tr class="h26 blue">
        <td><a href="info.html" title="简.奥斯汀全集（DVD-9）（赠BBC产品目录...">&nbsp;&nbsp;&nbsp;&nbsp;简.奥斯汀全集（DVD-9）（赠BBC产品目录...</a></td>
      ...
      <tr class="h26">
        <td>&nbsp;&nbsp;&nbsp;&nbsp;<a href="catlist.html">继续挑选商品</a></td>
