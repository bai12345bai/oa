		...
		<div id="header">
			...
			<div class="menu">
				<ul>
					...
					<li class="txt"><a href="help.html" target="_parent">帮助中心</a></li>
  		...
  		<div class="nav f_l w100p">
  			<ul>
  				...
  				<li><a href="catlist.html" target="_parent">家用电器</a></li>
  				<li><a href="catlist.html" target="_parent">手机数码</a></li>
  				<li><a href="catlist.html" target="_parent">日用百货</a></li>
  				<li><a href="catlist.html" target="_parent">&nbsp;书&nbsp;&nbsp;&nbsp;籍&nbsp;</a></li>
  				<li><a href="help.html" target="_parent">帮助中心</a></li>
  				<li><a href="help.html" target="_parent">免费开店</a></li>
  				<li><a href="help.html" target="_parent">全球咨询</a></li>  				
  			</ul>
  		</div>	<!--nav	end-->		
		</div> <!--header	end-->	
 </body>
