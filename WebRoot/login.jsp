...
<div id="container">
	...
	<div class="login">
		<ul class="form f_l">
			<h1><img src="images/title_login_2.png" alt="会员登录" /></h1>
			<li class="login_list"><label>会员名：</label><input type="text" name="users.name" />（可包含 a-z、0-9 和下划线）</li>
			<li class="login_list"><label>密&nbsp;&nbsp;&nbsp;码：</label><input type="text" name="users.password" />（至少包含 6 个字符）</li>
			<li class="a_c"><input type="submit" value="登录"></li>
			<!-- <img src="images/login.gif" alt="登录" /> -->
